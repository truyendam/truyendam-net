...
export default function AdultWarning({ onConfirm }: Props) {
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-90 flex flex-col items-center justify-center text-center text-white px-6">
      ...
      <button
        onClick={onConfirm}
        className="bg-pink-600 hover:bg-pink-700 text-white px-6 py-2 rounded text-sm md:text-base"
      >
