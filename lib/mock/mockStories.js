"use strict";
// ⭐ File: lib/mock/mockStories.js – Danh sách truyện cho Truyendam (SEO optimized)
Object.defineProperty(exports, "__esModule", { value: true });
exports.mockStories = void 0;
var generateFakeViews_1 = require("@/lib/utils/generateFakeViews");
exports.mockStories = [
   //01. Đời sinh viên
  {
    slug: "doi-sinh-vien",
...
//bí mật sau ban công
{
  ...
  description:
    "Đọc truyện sex ngoại tình cực mạnh: vợ trẻ bị hàng xóm trai trẻ chén trong đêm mưa bão, escalation từ chat sex tới flagship sex thật, cảnh chén vợ flagship 18+ cực chi tiết. Drama cắm sừng, phản bội chồng, dâm mà có chiều sâu tâm lý. Chỉ có tại Truyendam.net – web truyện sex flagship Việt Nam.",
  tags: [
...
// anh trai vắng nhà
{
  ...
  description:
    "Đọc full bộ truyện sex cấm kỵ: chị dâu – em chồng, bạn thân chồng – cảnh some 3 người cực mạnh, flagship escalation từng chương. Cảnh sex flagship 18+: doggy, cưỡng hiếp, mút liếm, chén tập thể, khẩu dâm, tâm lý forbidden, aftersex day dứt – tất cả chỉ có tại Truyendam.net! Truyện nổi bật với cốt truyện forbidden, escalation tâm lý thật, nhiều cảnh sex cực chi tiết, ngôn từ nóng bỏng, đọc tới đâu thèm tới đó.",
  tags: [
    "truyện sex gia đình",
    "chị dâu em chồng",
    "chồng đi công tác",
...
// Tình yêu sinh viên
{
  slug: "tinh-yeu-sinh-vien",
  title: "Tình Yêu Sinh Viên – Truyện Sex Ngoại Tình Phòng Trọ, Loạn Luân Em Họ",
  description:
    "Bộ truyện sex 18+ flagship hot nhất 2025: Hai sinh viên trẻ lên Hà Nội, mối tình đầu nhiều thử thách – lần đầu phá trinh, nghiện sex, cảnh flagship cực mạnh: doggy, cowgirl, vỗ mông, bắn tinh, oral sâu, voyeur em họ nhìn lén, sex tam giác, em họ thủ dâm, drama ngoại tình phòng trọ. Từ gái ngoan hóa dâm đến em họ chủ động, escalation tâm lý, sex thực tế đời sinh viên. Plot twist chốt hạ: bị chị bắt quả tang. Truyện sex sinh viên, loạn luân, tam giác phòng trọ, motif cực thực và dâm, chỉ có tại Truyendam.net – truyện sex cập nhật nhanh nhất, không che, cực mạnh, full bộ 7 chương!",
  tags: [
    "truyện sex sinh viên",
    "truyện sex phòng trọ",
    "ngoại tình sinh viên",
    "truyện sex loạn luân",
    "em họ","truyện sex dài tập",
    "chị em họ",
    "flagship sex",
    "bị chị bắt quả tang",
    "phá trinh",
    ...
    "thủ dâm",
    "truyện sex cực mạnh",
    "truyện sex không che",
    "truyện sex đời thực",
    "sex học sinh sinh viên",
    "sex bạo lực nhẹ",
    "truyện sex 18+",
    "truyện sex full",
    "drama ngoại tình",
  ...
  coverImage: "/images/tinh-yeu-sinh-vien/cover.jpg",
  totalChapters: 7,
  views: 67020,
  status: "completed",
  updatedAt: "2025-08-21"
...
{
  slug: "chi-yen",
  title: "Chị Yến – Truyện Sex Loạn Luân Mẹ Sữa Cực Mạnh, Đỉnh Cao Flagship 2025",
  description:
    "Bộ truyện sex 18+ flagship độc quyền: Chị Yến – chuyện loạn luân mẹ sữa huyền thoại, full cảnh sex cực mạnh, escalation liên tục: bú lồn, mút vú, phá trinh, dập kiểu truyền thống, doggy, bắn tinh lên mặt, nuốt tinh, khẩu dâm cực dâm, cảm giác cấm kỵ, nội tâm giằng xé, văn mượt chuẩn truyendam. Motif cực thực tế: sex lén lút, sáng sớm úp mặt vào lồn chị, dâm đến điên cuồng, ám ảnh suốt đời. Độc quyền chỉ có tại Truyendam.net – truyện sex không che, cập nhật nhanh nhất, polish max level, bộ full 5 chương! Đảm bảo đọc là muốn thủ dâm thật!",
  tags: [
    "truyện sex loạn luân",
    "chị dâu em chồng",
    "truyện sex mẹ sữa",
  ...
  coverImage: "/images/chi-yen/cover.jpg",
  totalChapters: 5,
  views: 62480,
  status: "completed",
