...
//chị bí mật nhé
{
  ...
  tags: [
    ...
    "lỡ chuyến xe",
    "truyện gợi cảm",
    "bí mật chị em","sex chị em","tình chị em",
...
//công nhân samsung
{
    ...
    description:
      "Phương – cô gái trẻ từ Hà Nội về Bắc Ninh làm công nhân – tưởng rằng tình yêu xa sẽ giữ được nguyên vẹn. Nhưng rồi cô bị lôi vào vòng xoáy dục vọng và trả thù, khi người yêu cũ và tổ trưởng cùng bước vào cuộc đời cô. Một truyện sex dài tập, đầy cảm xúc và bất ngờ.",
    tags: [
  ...
  //bạn tôi xin lỗi
    {
      ...
      description:
      "Giữa trưa hè oi ả, một người bạn thân ghé qua mượn hồ sơ, và rồi mọi ranh giới đã bị xóa nhòa... Truyện ngắn đỉnh cao về dục vọng và phản bội, nơi người vợ hiền ngoan bị bạn thân chén ngay tại nhà",
      tags: [
    "truyện sex ngắn",
    "truyện 1 chương",
    "sex vợ bạn",
...
//vợ làm sales bds
{
  ...
  description:
    "Truyện sex công sở về Hạnh – cô vợ trẻ làm sales bất động sản, nơi tiền bạc, quyền lực và dục vọng đan xen. Những hợp đồng đầy cám dỗ khiến Hạnh bị cuốn vào vòng xoáy tình dục với khách hàng và cả sếp, đánh mất ranh giới của mình.",
  tags: [
    "truyện dài",
    "ngoại tình",
    "công sở",
...
//chuyến công tác bất ổn
{
  ...
  description:
    "Chuyến công tác tưởng như bình thường lại trở thành ký ức nóng bỏng nhất đời Thủy: ngoại tình, dồn dập, chén liên tục tới kiệt sức. Truyện sex ngoại tình công sở cực mạnh, nhiều cảnh flagship, mô tả chân thực, escalation mạnh và khẩu dâm tinh tế.",
  tags: [
    "truyện sex ngắn",
    "ngoại tình công sở",
    "sex đồng nghiệp",
